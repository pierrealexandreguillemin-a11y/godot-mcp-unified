 ...
 */
export const isGodot44OrLater = (version) => {
 ...
 * Get Godot version
 */
export const getGodotVersion = async (godotPath) => {
 ...
 */
export const executeOperation = async (operation, params, projectPath, godotPath) => {
...
//# sourceMappingURL=GodotExecutor.js.map