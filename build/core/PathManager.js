 ...
 */
export const isValidGodotPathSync = (path) => {
    try {
 ...
 */
export const isValidGodotPath = async (path) => {
    // Check cache first
 ...
 */
export const getPlatformGodotPaths = () => {
    const possiblePaths = [
 ...
 */
export const detectGodotPath = async (customPath, strictPathValidation = false) => {
