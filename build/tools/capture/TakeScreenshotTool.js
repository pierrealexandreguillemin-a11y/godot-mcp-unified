...
export const takeScreenshotDefinition = {
...
`;
export const handleTakeScreenshot = async (args) => {
...
`;
        ...
        try {
            ...
            if (successMatch) {
                ...
                return createSuccessResponse(`Screenshot captured successfully!\n` +
            ...
            try {
                ...
                if (existsSync(tempScenePath))
                    unlinkSync(tempScenePath);
            }
            catch (e) {
...
//# sourceMappingURL=TakeScreenshotTool.js.map