...
export const handleAddNode = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('add_node', params, args.projectPath, godotPath);
        ...
        return createSuccessResponse(`Node added successfully: ${args.nodeName} (${args.nodeType})\n\nOutput: ${stdout}`);
    }
    catch (error) {
