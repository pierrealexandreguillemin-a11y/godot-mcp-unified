...
export const handleCreateScene = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('create_scene', params, args.projectPath, godotPath);
        ...
        return createSuccessResponse(`Scene created successfully: ${args.scenePath}\n\nOutput: ${stdout}`);
    }
    catch (error) {
...
//# sourceMappingURL=CreateSceneTool.js.map