...
export const exportMeshLibraryDefinition = {
...
export const handleExportMeshLibrary = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('export_mesh_library', params, args.projectPath, godotPath);
        ...
        return createSuccessResponse(`MeshLibrary exported successfully: ${args.outputPath}\n\nOutput: ${stdout}`);
    }
    catch (error) {
...
//# sourceMappingURL=ExportMeshLibraryTool.js.map