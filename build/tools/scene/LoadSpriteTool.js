 ...
 */
import { prepareToolArgs, validateBasicArgs, validateProjectPath, validateScenePath, validateFilePath, createSuccessResponse, } from '../BaseToolHandler.js';
import { createErrorResponse } from '../../utils/ErrorHandler.js';
import { detectGodotPath } from '../../core/PathManager.js';
import { executeOperation } from '../../core/GodotExecutor.js';
import { logDebug } from '../../utils/Logger.js';
export const loadSpriteDefinition = {
    name: 'load_sprite',
...
export const handleLoadSprite = async (args) => {
    ...
    try {
        ...
        logDebug(`Loading sprite ${args.texturePath} into node ${args.nodePath} in scene: ${args.scenePath}`);
        ...
        const { stdout, stderr } = await executeOperation('load_sprite', params, args.projectPath, godotPath);
        ...
        return createSuccessResponse(`Sprite loaded successfully: ${args.texturePath} into ${args.nodePath}\n\nOutput: ${stdout}`);
    }
    catch (error) {
...
//# sourceMappingURL=LoadSpriteTool.js.map