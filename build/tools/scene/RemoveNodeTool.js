...
export const handleRemoveNode = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('remove_node', params, args.projectPath, godotPath);
        ...
        return createSuccessResponse(`Node removed successfully: ${args.nodePath}\n\nOutput: ${stdout}`);
    }
    catch (error) {
...
//# sourceMappingURL=RemoveNodeTool.js.map