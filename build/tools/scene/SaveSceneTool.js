...
export const saveSceneDefinition = {
    name: 'save_scene',
...
export const handleSaveScene = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('save_scene', params, args.projectPath, godotPath);
...
//# sourceMappingURL=SaveSceneTool.js.map