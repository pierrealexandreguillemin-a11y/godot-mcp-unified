...
export const writeScriptDefinition = {
    name: 'write_script',
...
export const handleWriteScript = async (args) => {
    ...
    try {
        ...
        return createSuccessResponse(`Script ${action} successfully: ${scriptPath}\n` +
            `Lines: ${lines}\n` +
            `Path: ${fullPath}`);
    }
    catch (error) {
...
//# sourceMappingURL=WriteScriptTool.js.map