...
import { prepareToolArgs, validateBasicArgs, validateProjectPath, validateFilePath, createSuccessResponse, } from '../BaseToolHandler.js';
 ...
 */
const isGodot44OrLater = (version) => {
...
export const handleGetUid = async (args) => {
    ...
    try {
        ...
        const { stdout, stderr } = await executeOperation('get_uid', params, args.projectPath, godotPath);
...
//# sourceMappingURL=GetUidTool.js.map