...
export const handleAddAnimation = async (args: BaseToolArgs, ctx: ToolContext = defaultToolContext): Promise<ToolResponse> => {
  ...
  ctx.logDebug(`Adding animation ${typedArgs.animationName} to player: ${typedArgs.playerNodePath}`);
