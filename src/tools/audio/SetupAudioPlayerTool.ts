...
export const handleSetupAudioPlayer = async (args: BaseToolArgs, ctx: ToolContext = defaultToolContext): Promise<ToolResponse> => {
  ...
  try {
    ...
    ctx.logDebug(`Creating ${nodeType}: ${typedArgs.nodeName} in scene: ${typedArgs.scenePath}`);
